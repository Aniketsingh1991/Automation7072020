...
public class MouseHover {
	...
	public static void main(String[] args) {
		 ...
		 * dr.findElement(By.xpath("//button[@class='_2AkmmA _29YdH8']")).click();
		 * Actions act= new Actions(dr);
		 * act.moveToElement(dr.findElement(By.xpath("//span[text()='Men']"))).build().
		 * perform(); //Explicit wait WebDriverWait wait= new WebDriverWait(dr, 10);
		 * wait.until(ExpectedConditions.visibilityOf(dr.findElement(By.xpath(
		 * "//a[text()='T-Shirts']"))));
		 * dr.findElement(By.xpath("//a[text()='T-Shirts']")).click();
		 * wait.until(ExpectedConditions.elementToBeClickable(dr.findElement(By.xpath(
		 * "(//div[@class='_3aQU3C'])[1]"))));
		 * act.dragAndDropBy(dr.findElement(By.xpath("(//div[@class='_3aQU3C'])[1]")),
		 * 50, 0).build().perform(); boolean
		 * f=dr.findElement(By.xpath("//input[@class='_3uUUD5']")).isSelected();
		 */
